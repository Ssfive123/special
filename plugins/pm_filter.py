...
async def next_page(bot, query):
    ...
    btn.insert(0,
            [
                InlineKeyboardButton("📽️ ᴍᴏᴠɪᴇs", url="https://t.me/Filmzonex"),
                InlineKeyboardButton("ᴅᴇᴠᴇʟᴏᴘᴇʀ ⚙️", url="https://t.me/Films_bot_Panther")
            ])
...
async def auto_filter(client, msg, spoll=False):
    ...
    if offset != "":
        ...
        btn.insert(0,
            [InlineKeyboardButton(text="🎀 ᴍᴏᴠɪᴇ ᴄʜᴀɴɴᴇʟ 🎀",url="https://t.me/Filmzonex")]
        )
    else:
        btn.append(
...
async def advantage_spell_chok(msg):
    ...
    if movielist:
        one_button = InlineKeyboardMarkup([[InlineKeyboardButton("🔍 ɢᴏᴏɢʟᴇ", url="https://google.com/search"), InlineKeyboardButton("ʀᴇᴘᴏʀᴛ ⭕", url="https://t.me/Requestzonex")]])
